...
// sterren13
size_t JsonWriteAuthorize(char* dest, size_t maxLen, int nonce, const char* applicationId, std::initializer_list<const char*> Scops) {
    JsonWriter writer(dest, maxLen);
        ...
        WriteKey(writer, "args");
            {
                ...
                WriteKey(writer, "client_id");
                writer.String(applicationId);
                WriteKey(writer, "scopes");
                writer.StartArray();
                for (const char* scope : Scops) {
                    writer.String(scope);
                }
                writer.EndArray();
            }
